import { removeAtIndex } from "@portal/utils/lists";

import useStateFromProps from "./useStateFromProps";

export type FormsetChange<TValue = any> = (id: string, value: TValue) => void;
export interface FormsetAtomicData<
...
export type FormsetData<TData = Record<string, unknown>, TValue = any> = Array<
  FormsetAtomicData<TData, TValue>
>;
export interface UseFormsetOutput<
  TData = Record<string, unknown>,
  TValue = any
> {
...
function useFormset<TData = Record<string, unknown>, TValue = any>(
